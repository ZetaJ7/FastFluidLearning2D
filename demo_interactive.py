...
with torch.no_grad():
	while True:
		...
		#dataset = Dataset(w,h,1,1,interactive=True,average_sequence_length=n_time_steps,max_speed=params.max_speed,dt=dt,types=["magnus","image"],images=["fish","cyber","smiley","wing"],background_images=["artery1"])
		dataset = Dataset(w, h, 1, 1, interactive=True, average_sequence_length=n_time_steps,
						  max_speed=params.max_speed, dt=dt, types=["image"],images=["obs1"],background_images=["artery1","artery2"])
